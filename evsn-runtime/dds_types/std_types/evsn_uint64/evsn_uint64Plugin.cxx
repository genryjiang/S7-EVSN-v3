...
{
    try {
        EVSNUint64 *sample = new EVSNUint64();
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNUint64 >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNUint64PluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNUint64Plugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNUint64Plugin_get_serialized_sample_max_size, epd,
...
EVSNUint64Plugin_copy_sample(
    ...
    const EVSNUint64 *src)
{
    return ::EVSNUint64PluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNUint64 >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNUint64Plugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNUint64 **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNUint64Plugin_new(void) 
{ 
    ...
    EVSNUint64Plugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNUint64Plugin_destroy_sample;
    ...
    EVSNUint64Plugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNUint64Plugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNUint64Plugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNUint64 >::get().native();
    } catch (...) {
        ::EVSNUint64Plugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNUint64Plugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNUint64Plugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNUint64";
...
void
EVSNUint64Plugin_delete(struct PRESTypePlugin *plugin)
{
