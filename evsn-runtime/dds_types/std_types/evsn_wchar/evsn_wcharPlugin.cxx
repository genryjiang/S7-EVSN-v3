...
{
    try {
        EVSNWchar *sample = new EVSNWchar();
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNWchar >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNWcharPluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNWcharPlugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNWcharPlugin_get_serialized_sample_max_size, epd,
...
EVSNWcharPlugin_copy_sample(
    ...
    const EVSNWchar *src)
{
    return ::EVSNWcharPluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNWchar >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNWcharPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNWchar **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNWcharPlugin_new(void) 
{ 
    ...
    EVSNWcharPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNWcharPlugin_destroy_sample;
    ...
    EVSNWcharPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNWcharPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNWcharPlugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNWchar >::get().native();
    } catch (...) {
        ::EVSNWcharPlugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNWcharPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNWcharPlugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNWchar";
...
void
EVSNWcharPlugin_delete(struct PRESTypePlugin *plugin)
{
