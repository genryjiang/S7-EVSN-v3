...
{
    try {
        EVSNFloat *sample = new EVSNFloat();
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNFloat >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNFloatPluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNFloatPlugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNFloatPlugin_get_serialized_sample_max_size, epd,
...
EVSNFloatPlugin_copy_sample(
    ...
    const EVSNFloat *src)
{
    return ::EVSNFloatPluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNFloat >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNFloatPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNFloat **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNFloatPlugin_new(void) 
{ 
    ...
    EVSNFloatPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNFloatPlugin_destroy_sample;
    ...
    EVSNFloatPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNFloatPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNFloatPlugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNFloat >::get().native();
    } catch (...) {
        ::EVSNFloatPlugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNFloatPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNFloatPlugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNFloat";
...
void
EVSNFloatPlugin_delete(struct PRESTypePlugin *plugin)
{
