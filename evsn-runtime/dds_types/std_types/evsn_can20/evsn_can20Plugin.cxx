...
{
    try {
        EVSNCan20Frame *sample = new EVSNCan20Frame();
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNCan20Frame >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNCan20FramePluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNCan20FramePlugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNCan20FramePlugin_get_serialized_sample_max_size, epd,
...
EVSNCan20FramePlugin_copy_sample(
    ...
    const EVSNCan20Frame *src)
{
    return ::EVSNCan20FramePluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNCan20Frame >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNCan20FramePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNCan20Frame **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNCan20FramePlugin_new(void) 
{ 
    ...
    EVSNCan20FramePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNCan20FramePlugin_destroy_sample;
    ...
    EVSNCan20FramePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNCan20FramePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNCan20FramePlugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNCan20Frame >::get().native();
    } catch (...) {
        ::EVSNCan20FramePlugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNCan20FramePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNCan20FramePlugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNCan20Frame";
...
void
EVSNCan20FramePlugin_delete(struct PRESTypePlugin *plugin)
{
