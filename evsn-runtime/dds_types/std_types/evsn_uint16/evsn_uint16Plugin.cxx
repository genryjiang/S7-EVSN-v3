...
{
    try {
        EVSNUint16 *sample = new EVSNUint16();
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNUint16 >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNUint16PluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNUint16Plugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNUint16Plugin_get_serialized_sample_max_size, epd,
...
EVSNUint16Plugin_copy_sample(
    ...
    const EVSNUint16 *src)
{
    return ::EVSNUint16PluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNUint16 >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNUint16Plugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNUint16 **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNUint16Plugin_new(void) 
{ 
    ...
    EVSNUint16Plugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNUint16Plugin_destroy_sample;
    ...
    EVSNUint16Plugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNUint16Plugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNUint16Plugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNUint16 >::get().native();
    } catch (...) {
        ::EVSNUint16Plugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNUint16Plugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNUint16Plugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNUint16";
...
void
EVSNUint16Plugin_delete(struct PRESTypePlugin *plugin)
{
