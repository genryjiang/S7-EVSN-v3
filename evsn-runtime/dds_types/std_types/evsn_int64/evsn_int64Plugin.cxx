...
{
    try {
        EVSNInt64 *sample = new EVSNInt64();
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNInt64 >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNInt64PluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNInt64Plugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNInt64Plugin_get_serialized_sample_max_size, epd,
...
EVSNInt64Plugin_copy_sample(
    ...
    const EVSNInt64 *src)
{
    return ::EVSNInt64PluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNInt64 >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNInt64Plugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNInt64 **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNInt64Plugin_new(void) 
{ 
    ...
    EVSNInt64Plugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNInt64Plugin_destroy_sample;
    ...
    EVSNInt64Plugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNInt64Plugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNInt64Plugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNInt64 >::get().native();
    } catch (...) {
        ::EVSNInt64Plugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNInt64Plugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNInt64Plugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNInt64";
...
void
EVSNInt64Plugin_delete(struct PRESTypePlugin *plugin)
{
