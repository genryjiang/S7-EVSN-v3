...
{
    try {
        EVSNDouble *sample = new EVSNDouble();
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNDouble >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNDoublePluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNDoublePlugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNDoublePlugin_get_serialized_sample_max_size, epd,
...
EVSNDoublePlugin_copy_sample(
    ...
    const EVSNDouble *src)
{
    return ::EVSNDoublePluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNDouble >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNDoublePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNDouble **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNDoublePlugin_new(void) 
{ 
    ...
    EVSNDoublePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNDoublePlugin_destroy_sample;
    ...
    EVSNDoublePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNDoublePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNDoublePlugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNDouble >::get().native();
    } catch (...) {
        ::EVSNDoublePlugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNDoublePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNDoublePlugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNDouble";
...
void
EVSNDoublePlugin_delete(struct PRESTypePlugin *plugin)
{
