...
{
    try {
        EVSNFDCanFrame *sample = new EVSNFDCanFrame();
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNFDCanFrame >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNFDCanFramePluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNFDCanFramePlugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNFDCanFramePlugin_get_serialized_sample_max_size, epd,
...
EVSNFDCanFramePlugin_copy_sample(
    ...
    const EVSNFDCanFrame *src)
{
    return ::EVSNFDCanFramePluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNFDCanFrame >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNFDCanFramePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNFDCanFrame **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNFDCanFramePlugin_new(void) 
{ 
    ...
    EVSNFDCanFramePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNFDCanFramePlugin_destroy_sample;
    ...
    EVSNFDCanFramePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNFDCanFramePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNFDCanFramePlugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNFDCanFrame >::get().native();
    } catch (...) {
        ::EVSNFDCanFramePlugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNFDCanFramePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNFDCanFramePlugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNFDCanFrame";
...
void
EVSNFDCanFramePlugin_delete(struct PRESTypePlugin *plugin)
{
