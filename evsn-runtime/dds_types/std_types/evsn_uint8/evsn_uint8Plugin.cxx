...
{
    try {
        EVSNUint8 *sample = new EVSNUint8();
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNUint8 >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNUint8PluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNUint8Plugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNUint8Plugin_get_serialized_sample_max_size, epd,
...
EVSNUint8Plugin_copy_sample(
    ...
    const EVSNUint8 *src)
{
    return ::EVSNUint8PluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNUint8 >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNUint8Plugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNUint8 **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNUint8Plugin_new(void) 
{ 
    ...
    EVSNUint8Plugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNUint8Plugin_destroy_sample;
    ...
    EVSNUint8Plugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNUint8Plugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNUint8Plugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNUint8 >::get().native();
    } catch (...) {
        ::EVSNUint8Plugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNUint8Plugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNUint8Plugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNUint8";
...
void
EVSNUint8Plugin_delete(struct PRESTypePlugin *plugin)
{
