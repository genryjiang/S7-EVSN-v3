...
{
    try {
        EVSNPedalState *sample = new EVSNPedalState();
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNPedalState >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNPedalStatePluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNPedalStatePlugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNPedalStatePlugin_get_serialized_sample_max_size, epd,
...
EVSNPedalStatePlugin_copy_sample(
    ...
    const EVSNPedalState *src)
{
    return ::EVSNPedalStatePluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNPedalState >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNPedalStatePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNPedalState **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNPedalStatePlugin_new(void) 
{ 
    ...
    EVSNPedalStatePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNPedalStatePlugin_destroy_sample;
    ...
    EVSNPedalStatePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNPedalStatePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNPedalStatePlugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNPedalState >::get().native();
    } catch (...) {
        ::EVSNPedalStatePlugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNPedalStatePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNPedalStatePlugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNPedalState";
...
void
EVSNPedalStatePlugin_delete(struct PRESTypePlugin *plugin)
{
