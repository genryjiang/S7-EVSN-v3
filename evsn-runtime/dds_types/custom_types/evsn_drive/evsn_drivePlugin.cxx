...
void EVSNDriveGearPluginSupport_print_data(
    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printEnum((RTICdrEnum *)sample, "EVSNDriveGear", indent_level + 1);
}
...
{
    try {
        EVSNDriveGearCommand *sample = new EVSNDriveGearCommand();
...
EVSNDriveGearCommandPluginSupport_copy_data(
    EVSNDriveGearCommand *dst,
    const EVSNDriveGearCommand *src)
{
    try {
        *dst = *src;
    } catch (...) {
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            ...
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNDriveGearCommand >::get().native()
            ,
            &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EVSNDriveGearCommandPluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNDriveGearCommandPlugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                ::EVSNDriveGearCommandPlugin_get_serialized_sample_max_size, epd,
...
EVSNDriveGearCommandPlugin_copy_sample(
    ...
    const EVSNDriveGearCommand *src)
{
    return ::EVSNDriveGearCommandPluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            ...
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNDriveGearCommand >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNDriveGearCommandPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNDriveGearCommand **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNDriveGearCommandPlugin_new(void) 
{ 
    ...
    EVSNDriveGearCommandPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNDriveGearCommandPlugin_destroy_sample;
    ...
    EVSNDriveGearCommandPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNDriveGearCommandPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNDriveGearCommandPlugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNDriveGearCommand >::get().native();
    } catch (...) {
        ::EVSNDriveGearCommandPlugin_delete(plugin);
        return NULL;
    }
    #endif
    ...
    EVSNDriveGearCommandPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNDriveGearCommandPlugin_return_buffer;
    ...
    static const char * TYPE_NAME = "EVSNDriveGearCommand";
...
void
EVSNDriveGearCommandPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 

/* ----------------------------------------------------------------------------
*  Type EVSNMotorControllerStatus
* -------------------------------------------------------------------------- */
...
{
    try {
        EVSNMotorControllerStatus *sample = new EVSNMotorControllerStatus();
        ::rti::topic::allocate_sample(*sample);
        return sample;
    } catch (...) {
        return NULL;
...
EVSNMotorControllerStatusPluginSupport_copy_data(
    EVSNMotorControllerStatus *dst,
    const EVSNMotorControllerStatus *src)
{
    try {
        *dst = *src;
    } catch (...) {
    ...
    RTICdrTypeCode *type_code)
{
    try {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            DDS_TypeCodeFactory_get_instance(),
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNMotorControllerStatus >::get().native()
            ,
            &programProperty,
            RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            EVSNMotorControllerStatusPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            EVSNMotorControllerStatusPluginSupport_destroy_data,
            NULL , NULL );
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = ::EVSNMotorControllerStatusPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                ::EVSNMotorControllerStatusPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                PRESTypePlugin_interpretedGetSerializedSampleSize,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
...
EVSNMotorControllerStatusPlugin_copy_sample(
    ...
    const EVSNMotorControllerStatus *src)
{
    return ::EVSNMotorControllerStatusPluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        try {
            plugin.typeCode = (struct RTICdrTypeCode *)
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EVSNMotorControllerStatus >::get().native()
            ;
        } catch (...) {
            return RTI_FALSE;
        }
...
RTIBool EVSNMotorControllerStatusPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    EVSNMotorControllerStatus **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *cdrStream,
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EVSNMotorControllerStatusPlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    EVSNMotorControllerStatusPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EVSNMotorControllerStatusPlugin_destroy_sample;
    ...
    plugin->getSampleFnc =
    (PRESTypePluginGetSampleFunction)
    EVSNMotorControllerStatusPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    EVSNMotorControllerStatusPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    ::EVSNMotorControllerStatusPlugin_get_key_kind;
    ...
    */
    ...
    try {
        plugin->typeCode = (struct RTICdrTypeCode *)
        &::rti::topic::dynamic_type< ::EVSNMotorControllerStatus >::get().native();
    } catch (...) {
        ::EVSNMotorControllerStatusPlugin_delete(plugin);
        return NULL;
    }
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    EVSNMotorControllerStatusPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EVSNMotorControllerStatusPlugin_return_buffer;
    plugin->getBufferWithParams = NULL;
    plugin->returnBufferWithParams = NULL;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    ...
    static const char * TYPE_NAME = "EVSNMotorControllerStatus";
    plugin->endpointTypeName = TYPE_NAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}
...
void
EVSNMotorControllerStatusPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
